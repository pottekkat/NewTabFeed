...
// The shadcn/ui Select, built on @radix-ui/react-select. Radix owns the
// trigger/chevron layout and the portalled listbox, which gives correct chevron
// spacing (the reason we moved off the raw native <select>). Content is
// portalled and themed to match the Dialog primitive.
